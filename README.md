...
To generate 3D KBE use the script `kbe.py`. Some parameters can be set to change from default settings. 
* First to select the input image and the networks to be used:
...
* Then for specifying the cropping windows:
